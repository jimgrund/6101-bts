...
#' ## Preprocess Data
#' ### Global Filter Data
d1 <- subset(data_all, Year =="2016" & Origin =="IAD" | Origin =="BWI" | Origin =="DCA")
...
d2 <- subset(d1,select = c(DepartureDelayGroups,Year,Quarter,Month,DayofMonth,DayOfWeek,AirlineID,OriginAirportID,DestAirportID))
